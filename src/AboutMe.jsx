...
const REVEAL_CONTENT = [
  ...
  {
    upper: [
      "Estudiante de Ingeniera informtica",
    ],
    lower: "",
  },
  {
...
const ITEMS = [
  {
    id: "twitch", label: "SOBRE MÍ", handle: "@yourname", href: "https://twitch.tv/yourname", icon: "??", barIcon: icon1, bars: 1, newBars: [0], counts: ["56"],
